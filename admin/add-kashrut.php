    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-plus "></i> Add Kashrut</h1>
            </div>
                                    ...
                                    <form id="my-form"  method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label>Kashrut Name EN</label>
                                                <input class="form-control" id="name_en" name="name_en" placeholder="Enter Kashrut" type="text">
                                                <span style="font-size: 14px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="name_en_error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label dir="rtl">Kashrut Name HE</label>
                                        ...
                                        <div class="form-actions">
                                            <div onclick="add_new_kashrut()" class="btn btn-primary btn-lg">
