        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                    <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-files-o "></i>&nbsp;<b><?=ucfirst($team)?></b> B2B Ledger Detail</h1>
                </div>
                <!-- end col -->
                    ...
                    <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body">
                                ...
                                </div>&nbsp;&nbsp;<div id="delivery_swipe_div_go_back"  onclick="window.location.href='b2b-ledger.php'" class="btn btn-success btn-lg">
                                    <i class="fa fa-arrow-left"></i>
                                    Go Back
                                </div>
                                <br><br>
                                <div  id="add-delivery-swipe" style="display: none">
                                    <form>
                                        <fieldset>
                                            <input name="authenticity_token" type="hidden">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" id="delivery_swiped_by" name="delivery_swiped_by" placeholder="Enter Swiped By" type="text" required>
                                                <span style="font-size: 14px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="delivery_swiped_by_error"></span>
                                            </div>

                                            <div class="form-group">
                                                <label>Comments</label>
                                                <input class="form-control" id="delivery_comments" name="delivery_comments" placeholder="Enter Comments" type="text" required>
                                                <span style="font-size: 14px; color: red; width: 100%;text-align: left; padding: 9px;text-transform: none;" id="delivery_comments_error"></span>
                                            </div>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
                            ...
                            <header>
                                ...
                                <h2><?=ucfirst($team)?> B2B Ledger Detail </h2>
