                                ...
                                <div class="widget-body">
                                    ...
                                    <form id="my-form"  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions">
                                            <div onclick="add_new_tag()" class="btn btn-primary btn-lg">
