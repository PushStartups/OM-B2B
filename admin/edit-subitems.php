                                    ...
                                    <form>
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label>Name EN</label>
                                                <input class="form-control" id="name_en" name="name_en" value="<?=$subitem['name_en']?>" placeholder="Enter SubItem" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="direction:RTL;" class="form-control" id="name_he" value="<?=$subitem['name_he']?>" name="name_he"  type="text">
                                            ...
                                            <div class="form-group">
                                                <label>Price</label>
                                                <input class="form-control" id="item_price" name="item_price" value="<?=$subitem['price']?>" placeholder="Enter Price" type="text">
                                        ...
                                        <div class="form-actions">
                                            <div onclick="edit_subitems('<?=$subitem_id?>','<?=$_SERVER['REQUEST_URI']?>')" class="btn btn-primary btn-lg">
