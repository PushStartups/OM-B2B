        ...
        <div id="content">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                    <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-tags "></i><?=$_SESSION['company_name']?>'s Restaurant Discounts</h1>
                </div>
                <!-- end col -->
...
<!--                                            <th>Delete</th>-->
                                        ...
                                        $b2bRestDiscounts = DB::query("select * from b2b_rest_discounts where company_id = '".$_SESSION['company_id']."'");
