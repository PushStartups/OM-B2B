...
<head>
	...
	<style>
		...
		.btn-primary, .btn-primary, .btn-primary, .open>.dropdown-toggle.btn-primary{
			border-radius: 40px;
			background: #63df7e;
			border-color: #63df7e;
			transition: all 1s;
								...
								<div id="">
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="email" id="adminUser" name="adminUser">
...
<!--								<div class="note">-->
<!--									<a href="#" onclick="show_forgot_field()">Forgot password?</a>-->
<!---->
<!--								</div>-->
							...
							<footer>
								...
								<input type="button" name="signin" id="signin" class="btn btn-primary" value="Sign in">
...
<!--						<div style="display:none" id="show-forget-fields">-->
<!--							<fieldset>-->
<!---->
<!--								<div-->
<!---->
...
<!--										<label class="label">E-mail</label>-->
<!--										<label class="input"> <i class="icon-append fa fa-user"></i>-->
<!--											<input type="email" id="forget-email" name="forget-email">-->
<!--											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Please enter email address/username</b></label>-->
<!--									</section>-->
<!---->
<!--								</div>-->
<!--								<div class="note">-->
<!--									<a href="#" onclick="show_login_field()">Go Back</a>-->
<!--								</div>-->
<!--							</fieldset>-->
<!--							<footer>-->
