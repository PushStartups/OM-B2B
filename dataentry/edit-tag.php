    ...
    <div id="content">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
                <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-cutlery "></i> Update Tags</h1>
            </div>
                                    ...
                                    <form method="post">
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input class="form-control" id="name_en" name="name_en" placeholder="Enter Name" value="<?=$tags['name_en']?>" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="direction:RTL;" class="form-control" id="name_he" name="name_he" value="<?=$tags['name_he']?>"  type="text">
                                        ...
                                        <div class="form-actions">
                                            <div onclick="edit_tags('<?=$tags_id?>','<?=$_SERVER['REQUEST_URI']?>')" class="btn btn-primary btn-lg">
