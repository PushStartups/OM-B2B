...
$('#rest_select_id').on('change', function() {
    ...
    window.location.href = 'b2b-ledger-detail.php?id='+this.value;
...
$('#delivery_select_id').on('change', function() {
    ...
    window.location.href = 'b2b-ledger-detail-delivery.php?id='+this.value;
...
$('#company_select_id').on('change', function() {
    ...
    window.location.href = 'b2b-ledger-detail-company.php?id='+this.value;
...
function update_ledger(ledger_id)
{
    ...
    $.ajax({
        ...
        dataType:"json",
        success: function (data) {
            alert("B2B Ledger Updated Successfully");
            window.location.href = "b2b-ledger.php";
            hideLoading();
