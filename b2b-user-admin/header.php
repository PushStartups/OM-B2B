...
<aside id="left-panel">
    <nav>
        <ul>
            ...
            <li>
                <a href="add-credit-card.php" title="Add Credit Card"><i class="fa fa-lg fa-fw fa-credit-card"></i> <span class="menu-item-parent">Credit Card</span></a>
            </li>
            <li>
                <a href="reset-password.php" title="Orders"><i class="fa fa-lg fa-fw fa-key"></i> <span class="menu-item-parent">Reset Password</span></a>
            </li>
            <li>
